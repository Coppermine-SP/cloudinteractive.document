...
namespace DocumentTestApp
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var document =
                //PDFDocument.ImportFromFile("C:\\Users\\Coppermine\\Downloads\\공군 전문특기병(IT개발관리병) 지원자격 및 선발기준.pdf");
                //PDFDocument.ImportFromFile("X:\\Personal\\창원대학교\\2023\\2023 정보통신공학개론\\2020 기말고사 범위 내용 요약.pdf", new int[]{3});
                //PDFDocument.ImportFromFile("X:\\ePub\\파이썬 데이터과학 -생능출판.pdf", new int[] { 204 });
                PDFDocument.ImportFromFile("X:\\ePub\\스튜어트 미분적분학 9E.pdf", new int[] { 455 });
            document.Export();
        }
    }
}